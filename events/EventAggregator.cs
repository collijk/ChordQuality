...
namespace ChordQuality.events
{
    ...
    public class EventAggregator : IEventAggregator
    {
        ...
        /// has been published.
        /// </summary>
        /// <typeparam name="TMessage">The type of message the subscriber is 
        /// interested in.</typeparam>
        /// <param name="action">The action performed by the subscription token 
        /// when the message of interest is published.</param>
        /// <returns>A subscription token that notifies the subscriber when the 
        /// message of interest is published.</returns>
        ...
        /// </summary>
        /// <typeparam name="TMessage">The type of message associated with 
        /// the subscription.</typeparam>
        ...
        /// </summary>
        /// <param name="exceptMessages">An array of messageTypes we do not
        /// wish to clear the subscriptions from.</param>
